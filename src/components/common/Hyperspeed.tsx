...
export const DEFAULT_EFFECT_OPTIONS: HyperspeedEffectOptions = {
  onSpeedUp: () => {},
  onSlowDown: () => {},
...
export const Hyperspeed: React.FC<{ effectOptions?: HyperspeedEffectOptions }> = ({
  ...
  useEffect(() => {
    ...
    class App {
      constructor(container: HTMLElement, options: any = {}) {
        ...
        // CRITICAL FIX: Append element BEFORE creating EffectComposer
        // so WebGL context attributes are initialized and getContext() is not null
    ...
    try {
      ...
      myApp.loadAssets().then(myApp.init).catch(err => console.warn('Hyperspeed assets error:', err));
    } catch (err) {
      console.warn('Hyperspeed WebGL init error, skipping 3D effect:', err);
    }
